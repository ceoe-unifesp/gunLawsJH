...
[![R-CMD-check](https://github.com/ceoe-unifesp/gunLawsJH/workflows/R-CMD-check,yaml/badge.svg)](https://github.com/ceoe-unifesp/gunLawsJH/actions/workflows/R-CMD-check.yaml)
